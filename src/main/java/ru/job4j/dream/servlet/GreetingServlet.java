...
public class GreetingServlet extends HttpServlet {
    ...
    /**
     * ajax посылает данные типа json в doPost().
     * дессиарилизуем идобавляем в лист.
     * Обратно сериализуем и отправляем ответ типа json для вывода на сайт.
     */
    @Override
     ...
     * и отправка этого списка в виде json
     */
    @Override
